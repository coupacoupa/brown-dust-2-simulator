  ...
  costumes: [
    {
      ...
      skill: {
        ...
        effects: [
          { id: "sonya_shadow_vuln", type: "debuff_vulnerability", value: 55, duration: 4, target: "target_enemy", condition: { kind: "not", condition: { kind: "chain_min", value: 6 } } },
          { id: "sonya_shadow_darkvuln", type: "debuff_property_vulnerability", element: "dark", value: 75, duration: 4, target: "target_enemy", condition: { kind: "chain_min", value: 6 } },
        ],
      ...
      upgrades: [
        ...
        { spCost: 3, cooldown: 3, scaling: 300, effects: [
          { id: "sonya_shadow_vuln", type: "debuff_vulnerability", value: 80, duration: 4, target: "target_enemy", condition: { kind: "not", condition: { kind: "chain_min", value: 6 } } },
          { id: "sonya_shadow_darkvuln", type: "debuff_property_vulnerability", element: "dark", value: 115, duration: 4, target: "target_enemy", condition: { kind: "chain_min", value: 6 } },
        ] },
        ...
        { spCost: 3, cooldown: 3, scaling: 400, effects: [
          { id: "sonya_shadow_vuln", type: "debuff_vulnerability", value: 105, duration: 4, target: "target_enemy", condition: { kind: "not", condition: { kind: "chain_min", value: 6 } } },
          { id: "sonya_shadow_darkvuln", type: "debuff_property_vulnerability", element: "dark", value: 155, duration: 4, target: "target_enemy", condition: { kind: "chain_min", value: 6 } },
        ] },
